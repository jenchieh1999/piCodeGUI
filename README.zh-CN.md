...
> 当前状态：私有预发布版本，版本号 `0.1.0`。主流程已经可以使用，但距离正式发布质量仍需要补齐签名安装包、稳定更新源、更多回归测试和真实跨版本升级验证。
...
- 主题系统：20+ 内置主题、用户自建主题、删除自建主题、对话背景图片、字体设置，以及 Claude Code、Codex、Trae、赛博朋克、星球大战等风格主题。
